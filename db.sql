...
(5, 'Tarrina Dulce de Leche', 7.50, 'El sabor tradicional argentino con vetas de manjar artesanal.', 35, 'https://images.unsplash.com/photo-1551024506-0bccd828d307?w=800', 'ACTIVO', 'Tradicional', '150 g', 'VASO', 0, 1, NOW(), NOW()),
(6, 'Sorbet Mango & Pasión', 6.00, 'Sorbet frutal a base de agua, 100% natural y sin lactosa.', 22, 'https://images.unsplash.com/photo-1501443762994-82bd5dace89a?w=800', 'ACTIVO', 'Sorbetes', '130 g', 'VASO', 0, 1, NOW(), NOW()),
...
(10, 'Paleta Berries Silvestres', 5.80, 'Frutos rojos enteros seleccionados y congelados al instante.', 30, 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=800', 'ACTIVO', 'Frutales', '95 g', 'PALETA', 0, 1, NOW(), NOW()),
...
(15, 'Barra Stracciatella', 8.50, 'Nata pura campesina cruzada con lajas finas de chocolate amargo.', 16, 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=800', 'ACTIVO', 'Clásicos', '170 g', 'BARRA', 0, 1, NOW(), NOW()),
...
(17, 'Copa Trilogía Cremissimo', 15.00, 'Copa de cristal clásica: combina hasta 3 sabores a elección.', 40, 'https://images.unsplash.com/photo-1567206563064-6f60f40a2b57?w=800', 'ACTIVO', 'Personalizables', '300 g', 'COPA', 1, 3, NOW(), NOW()),
(18, 'Vaso Mediano Bi-Sabor', 10.00, 'Porción perfecta para dos gustos contrastantes en vaso térmico.', 45, 'https://images.unsplash.com/photo-1551024506-0bccd828d307?w=800', 'ACTIVO', 'Personalizables', '200 g', 'VASO', 1, 2, NOW(), NOW()),
(19, 'Tarrina Familiar 1 Litro', 32.00, 'Presentación de 1 Litro: escoge hasta 4 sabores de nuestra vitrina.', 25, 'https://images.unsplash.com/photo-1570197788417-0e82375c9371?w=800', 'ACTIVO', 'Personalizables', '1000 ml', 'LITRO', 1, 4, NOW(), NOW()),
(20, 'Copa Degustación Especial', 18.50, 'Presentación festiva para maridar 3 sabores con toppings.', 20, 'https://images.unsplash.com/photo-1580915411954-282cb1b0d780?w=800', 'ACTIVO', 'Personalizables', '350 g', 'COPA', 1, 3, NOW(), NOW());
